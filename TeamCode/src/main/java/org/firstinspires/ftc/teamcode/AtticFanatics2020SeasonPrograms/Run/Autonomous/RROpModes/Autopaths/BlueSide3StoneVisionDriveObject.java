...
import org.firstinspires.ftc.teamcode.AtticFanatics2020SeasonPrograms.Referenced.NoDriveConfigureDriveObject;
...
@Config
@Autonomous
public class BlueSide3StoneVisionDriveObject extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        NoDriveConfigureDriveObject mech = new NoDriveConfigureDriveObject();
        ...
        Pose2d ingest1lower = new Pose2d(-44.5,20.5, Math.toRadians(305.0));
        ...
        Pose2d ingest2middle = new Pose2d(-41,18.5, Math.toRadians(270.0));
        ...
        Pose2d ingest3middle = new Pose2d(-56, 26.5, Math.toRadians(165.0));
        ...
        Pose2d parkpositionmiddle = new Pose2d(4.0,46.0, Math.toRadians(180.0));
        ...
        Pose2d ingest2upper = new Pose2d(-33,20.5, Math.toRadians(270.0));
        ...
        Pose2d foundationpickupupper = new Pose2d (21,40, Math.toRadians(180.0));
        Pose2d foundationshoveupper = new Pose2d(51.0,50.0,Math.toRadians(180.0));
        Pose2d middlepassageupper = new Pose2d(2.0, 40.0, Math.toRadians(180.0));
        Pose2d parkpositionupper = new Pose2d(4.0,46.0, Math.toRadians(180.0));
