...
//   StageSwitchingPipeline detector;
    ...
    public class StageSwitchingPipeline extends OpenCvPipeline
    {
        ...
        public Mat processFrame(Mat input)
        {
            ...
            Core.extractChannel(yCbCrChan2Mat, yCbCrChan2Mat, 2);//only care about cb channel

            Imgproc.threshold(yCbCrChan2Mat, thresholdMat, 102, 255, Imgproc.THRESH_BINARY_INV);
            //thresholdMat is purely b/w, with the split at cb=102

            yCbCrChan2Mat.copyTo(all);//copies mat object

            updateVals(input); // valMid, valLeft, and valRight (see below) are what we need to look at

            //THE REST OF THIS IS ONLY FOR AESTHETIC PURPOSES
