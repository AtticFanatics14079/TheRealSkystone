...
@Autonomous(name="RedSideFoundationWallPark")
public class RedSideFoundationWallPark extends LinearOpMode {

    private final String fileName = "RedSideFoundationWallPark.txt";
