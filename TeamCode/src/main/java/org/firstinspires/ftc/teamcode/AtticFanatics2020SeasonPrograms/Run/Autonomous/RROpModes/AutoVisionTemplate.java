...
@Config
@Autonomous
public class AutoVisionTemplate extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d end1 = new Pose2d(48,48,Math.toRadians(90));
        Pose2d end2 = new Pose2d(36,36,Math.toRadians(90));
        Pose2d end3 = new Pose2d(24,24,Math.toRadians(90));
        ...
        */
        ...
        //DRIVE TO THE FOUNDATION IN ALL CASES
        drive.followTrajectorySync(
                drive.trajectoryBuilder()
                    .splineTo(start)
                    .build()
