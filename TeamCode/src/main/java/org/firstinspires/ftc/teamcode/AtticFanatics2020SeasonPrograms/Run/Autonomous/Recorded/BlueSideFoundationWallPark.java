...
@Autonomous(name="BlueSideFoundationWallPark")
public class BlueSideFoundationWallPark extends LinearOpMode {

    private final String fileName = "BlueSideFoundationWallPark.txt";
