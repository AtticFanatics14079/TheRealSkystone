...
public class RedSide2StoneUpper extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d ingest1stop = new Pose2d(-32, -14, Math.toRadians(135.0));
        Pose2d ingest2 = new Pose2d(-46.0,-24.0, Math.toRadians(135.0));
        Pose2d ingest2stop = new Pose2d(-56.0,-14.0, Math.toRadians(135.0));
