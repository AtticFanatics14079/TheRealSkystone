...
public class RedSide3StoneLower extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d ingest1 = new Pose2d(-42.5,-25.5, Math.toRadians(55.0));
        Pose2d ingest2 = new Pose2d(-50,-17.5, Math.toRadians(90.0));
        Pose2d ingest2stop = new Pose2d(ingest2.getX()+2.5, ingest2.getY()-3.3, Math.toRadians(185.0));
        Pose2d ingest2drive = new Pose2d(ingest2.getX()-6.5, ingest2.getY()-5.0, Math.toRadians(185.0));
        Pose2d ingest3 = new Pose2d(ingest2drive.getX(), ingest2drive.getY() + 1, Math.toRadians(185.0));
        Pose2d ingest3temp = new Pose2d(-41,-17, Math.toRadians(185.0));
