...
public class BlueSide3StoneUpper extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d ingest1 = new Pose2d(-26.5,25, Math.toRadians(305.0));
        Pose2d ingest2 = new Pose2d(-35,19, Math.toRadians(270.0));
        Pose2d ingest2stop = new Pose2d(ingest2.getX()+3.5, ingest2.getY()+3, Math.toRadians(175.0));
        Pose2d ingest2drive = new Pose2d(ingest2.getX()-6.5, ingest2.getY()+5.0, Math.toRadians(175.0));
        Pose2d ingest3 = new Pose2d(-49.0, 22, Math.toRadians(175.0));
