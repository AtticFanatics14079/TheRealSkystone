...
public class BlueSide3StoneUpper extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d ingest1 = new Pose2d(-28.5,25, Math.toRadians(310.0));
        Pose2d ingest2 = new Pose2d(-33,19.5, Math.toRadians(270.0));
        Pose2d ingest2stop = new Pose2d(ingest2.getX()+4.5, ingest2.getY()+3, Math.toRadians(180.0));
        Pose2d ingest2drive = new Pose2d(-40.5, 24, Math.toRadians(175.0));
        Pose2d ingest3 = new Pose2d(-48.0, 25, Math.toRadians(170.0));
        ...
        Pose2d foundationpickup = new Pose2d (21,38.5,Math.toRadians(180.0));
        Pose2d foundationshove = new Pose2d(51.0,45.0,Math.toRadians(180.0));
        Pose2d middlepassage = new Pose2d(2.0, 39.0, Math.toRadians(180.0));
        Pose2d parkposition = new Pose2d(4.0,40.0, Math.toRadians(180.0));
